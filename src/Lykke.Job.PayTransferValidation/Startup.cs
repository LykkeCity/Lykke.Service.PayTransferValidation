...
using Lykke.Job.PayTransferValidation.Settings;
using Lykke.Job.PayTransferValidation.Modules;
using Lykke.Logs;
...
namespace Lykke.Job.PayTransferValidation
{
    [PublicAPI]
    public class Startup
    {
        private const string ApiVersion = "v1";
        private const string ApiName = "PayTransferValidationJob API";
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                services.AddLykkeLogging(
                    settingsManager.ConnectionString(s => s.PayTransferValidationJob.Db.LogsConnString),
                    "PayTransferValidationJobLog",
                ...
                builder.RegisterModule(new JobModule(appSettings.PayTransferValidationJob, settingsManager.Nested(x => x.PayTransferValidationJob)));
