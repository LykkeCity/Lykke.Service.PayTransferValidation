...
namespace Lykke.Service.PayTransferValidation
{
    ...
    public class Startup
    {
        ...
        {
            ApiTitle = "PayTransferValidation API",
            ApiVersion = "v1"
        };
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "PayTransferValidationLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.PayTransferValidationService.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("PayTransferValidation", channelOptions =>
                        {
